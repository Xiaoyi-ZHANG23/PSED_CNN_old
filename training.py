...
hyper_params = {'batch_size':64, 'num_epochs':50, 'eval_freq':30,
                'learning_rate':1e-3, 'weight_decay':1e-4, 'step_size':60, 'gamma':0.5,
                 'optimizer':'Adam', 'patience':2}


model_name = 'SingleGasCNN'
...
X_train, y_train = load_data(
    '/data/yll6162/data/train',
    '/data/yll6162/data/all.csv',
    'cm3_per_cm3_value',
    'project',
)
